    ...
    await LoginService({ email, password })
      .then((response) => {
        ...
        if(data?.locationDetails){
          var labelCount = 0;
          if(data?.locationDetails?.location_id !== null || data?.locationDetails?.branch_id !== null || data?.locationDetails?.facility_id !== null ||
          data?.locationDetails?.building_id !== null || data?.locationDetails?.floor_id !== null || data?.locationDetails?.lab_id !== null ){
            labelCount = data?.locationDetails?.location_id !== null ? labelCount + 1 : labelCount;
            labelCount = data?.locationDetails?.branch_id !== null ? labelCount + 1 : labelCount;
            labelCount = data?.locationDetails?.facility_id !== null ? labelCount + 1 : labelCount;
            labelCount = data?.locationDetails?.building_id !== null ? labelCount + 1 : labelCount;
            labelCount = data?.locationDetails?.floor_id !== null ? labelCount + 1 : labelCount;
            labelCount = data?.locationDetails?.lab_id !== null ? labelCount + 1 : labelCount;
